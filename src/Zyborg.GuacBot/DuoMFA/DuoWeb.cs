// Borrowed from:
//    https://github.com/duosecurity/duo_dotnet/blob/master/DuoWeb/DuoWeb.cs
...
namespace Zyborg.GuacBot.DuoMFA
{
	public static class DuoWeb
	{
        ...
        public static string SignRequestSimple(string ikey, string skey, string username, DateTime? current_time=null)
		{
			string duo_sig;
